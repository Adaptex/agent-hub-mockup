...
- **Purpose:** Phase 0 UI mockup — tend agents, feed skills, 3D evolution; `localStorage` only.
- **Not in scope:** real agent run, Daily Companion file sync, Supabase/backend.
- **Cursor:** open this folder as workspace root; read `CLAUDE.md` at session start.
